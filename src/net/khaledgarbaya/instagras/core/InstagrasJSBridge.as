		...
		public function InstagrasJSBridge()
		{
			try {
				if( ExternalInterface.available ) {
					...
					same as the id.*/
					ExternalInterface.call( "IG.setSWFObjectID", ExternalInterface.objectID );
				}
			} catch( error:Error ) {}
		}
		
		/**
		 * source  :  https://github.com/Instagram/instagram-javascript-sdk (Official JS SDK For Instagram)
		 */
